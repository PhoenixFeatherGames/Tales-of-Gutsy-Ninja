  ...
  return (
    <main className="p-8 max-w-2xl mx-auto">
      ...
      <div className="mb-6 p-4 bg-zinc-100 dark:bg-zinc-800 rounded-lg">
        ...
        <p className="mb-2">Current: <span className="font-mono text-orange-700 dark:text-orange-400">{currentUsername || <em>none set</em>}</span></p>
        <form onSubmit={handleUsernameChange} className="flex flex-col gap-2 max-w-xs">
          ...
          {usernameMsg && <p className="text-sm mt-1 text-orange-700 dark:text-orange-400">{usernameMsg}</p>}
        </form>
      </div>
      <div className="mb-6 p-4 bg-zinc-100 dark:bg-zinc-800 rounded-lg">
        ...
        <form onSubmit={handlePasswordChange} className="flex flex-col gap-2 max-w-xs">
          ...
          {passwordMsg && <p className="text-sm mt-1 text-orange-700 dark:text-orange-400">{passwordMsg}</p>}
        </form>
      </div>
