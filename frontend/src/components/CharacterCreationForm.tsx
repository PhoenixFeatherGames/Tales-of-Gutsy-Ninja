...
// Removed duplicate export default function CharacterCreationForm
  ...
  return (
    <form className="max-w-2xl mx-auto p-4 bg-white rounded shadow space-y-4" onSubmit={handleSubmit}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={e => {
                ...
                // Reset cross clan UI if not a cross clan
        ...
        {/* Cross clan UI only if cross clan is selected */}
        {form.clan && form.clan.includes('/') && (
          <div>
